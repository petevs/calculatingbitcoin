  ...
  return (
    <>
      ...
      {calcVisibility && (
        <DetailedCalc>
          <ResultRow
            label={`Sale Proceeds (${details.bitcoin} x ${nWC(
          ...
          />
          <ResultRow
            label={`Less: Cost (${details.bitcoin} x ${nWC(
              details.averageCost
            )})`}
            value={results.cost}
            thousandSeparator={true}
          ...
          />
          <ResultRow
            label={`Taxable Gain (${nWC(results.profit)} x ${
              results.gainRate
            }%)`}
          ...
          />
          <ResultRow
            label={`Taxes Owed (${nWC(results.taxableGain)} x ${
              details.taxRate
            }%)`}
            value={results.taxes}
            thousandSeparator={true}
